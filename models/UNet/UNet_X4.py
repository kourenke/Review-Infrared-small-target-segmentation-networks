...
class UNet_X4(nn.Module):
    def __init__(self, in_channel=3, out_channel=1):
        super(UNet_X4, self).__init__()
        #Encode
    ...
    def forward(self, x):
        ...
        # Bottleneck
        bottleneck = self.bottleneck(encode_pool2);#print('bottleneck:', bottleneck.size())
        
        # Decode
        # decode_block4 = self.conv_decode4(encode_block4, bottleneck);print('decode_block4:', decode_block4.size())
        # decode_block3 = self.conv_decode3(encode_block3, bottleneck);#print('decode_block3:', decode_block3.size())
        decode_block2 = self.conv_decode2(encode_block2, bottleneck);#print('decode_block2:', decode_block2.size())
